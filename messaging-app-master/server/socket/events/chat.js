...
module.exports = (socket) => {
  ...
  socket.on('chat/insert', async (args) => {
    try {
      ...
      // tạo ra inbox mới nếu chưa có hoặc cập nhật nếu có rồi
  ...
  // event khi bạn bè đọc tin nhắn your của bạn
    ...
    async ({ userId, chatsId, roomId, deleteForEveryone }) => {
      try {
        ...
        if (deleteForEveryone) {
          ...
          // xóa tin nhắn khi tất cả thành viên đều xóa tin nhắn đó
