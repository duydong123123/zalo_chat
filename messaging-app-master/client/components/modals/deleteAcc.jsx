...
function DeleteAccount() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-2xl font-bold">Xóa tài khoản</h1>
        ...
        <p className="mb-4">
          Khi tài khoản của bạn được xoá, tất cả thông tin của bạn sẽ bị mất vĩnh viễn, bao gồm thông tin, danh sách liên lạc và chat
        </p>
        ...
        <span className="flex gap-2 mt-4 justify-end">
          ...
          >
            <p className="font-bold text-white/90">Xóa tài khoản</p>
          </button>
        </span>
      </div>
    </div>
