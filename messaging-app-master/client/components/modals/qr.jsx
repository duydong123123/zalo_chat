      ...
      >
        {qr && (
          <>
            ...
            <p className="p-4 text-sm">{`Đây là mã QR của riêng bạn, nếu bạn chia sẻ với user khác, họ có thể scan bằng ${config.brandName} camera của họ để thêm bạn vào danh sách liên lạc`}</p>
          </>
        )}
      </div>
    </div>
