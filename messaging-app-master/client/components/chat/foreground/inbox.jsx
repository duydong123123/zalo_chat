...
function Inbox({ inboxes, setInboxes }) {
  ...
  useEffect(() => {
    socket.on('inbox/find', async (payload) => {
      // concat data inboxes cũ với data mới
      setInboxes((prev) => {
            ...
            >
              ...
              <div className="overflow-hidden grid gap-0.5">
                ...
                <div className="grid grid-cols-[1fr_auto] gap-2 items-center">
                  ...
                  {/* kiểm tra xem tin nhắn trong elem có được gửi bởi người dùng hiện tại (master._id) hay không 
                  và hiển thị biểu tượng trạng thái tin nhắn (đã đọc hoặc chưa đọc) tương ứng */}
