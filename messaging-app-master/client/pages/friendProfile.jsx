          ...
          <div className="p-4 flex flex-col items-center">
            ...
            <div className="w-full text-center mt-4 overflow-hidden">
              ...
              {/* <p className="text-sm opacity-60">
                {profile.online
                  ? 'online'
                   : `las seen ${moment(profile.updatedAt).fromNow()}`}
              </p> */}
            </div>
          </div>
          <div className="grid">
            {[
              ...
              { label: 'Thông tin', data: profile.bio, icon: <bi.BiInfoCircle /> },
              { label: 'Số điện thoại', data: profile.phone, icon: <bi.BiPhone /> },
          ...
          {profile.saved && (
            <div className="mt-6 grid">
              ...
              >
                ...
                <p className="font-bold">Xóa liên lạc</p>
              </button>
            </div>
          )}
        </div>
