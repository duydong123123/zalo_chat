            ...
            {[
              {
                ...
                desc: 'Mọi người sẽ tìm bạn bằng username này',
                icon: <bi.BiAt />,
              },
              { label: 'Thông tin cá nhân', data: profile.bio, icon: <bi.BiInfoCircle /> },
              { label: 'Số điẹn thoại', data: profile.phone, icon: <bi.BiPhone /> },
